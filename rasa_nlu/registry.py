...
from rasa_nlu.custom_component.sentiment import SentimentAnalyzer
from rasa_nlu.custom_component.location import LocationExtractor
from rasa_nlu.custom_component.chit_chat import ChitChatExtractor
...
component_classes = [
    ...
    EmbeddingIntentClassifier,
    # custom one
    SentimentAnalyzer, LocationExtractor, ChitChatExtractor
]

# Mapping from a components name to its class to allow name based lookup.
registered_components = {c.name: c for c in component_classes}
print(registered_components, "registry.py----->registered_components")
...
old_style_names = {
    ...
    "custom_component_sentiment": "SentimentAnalyzer",
    "custom_component_location": "LocationExtractor",
    "custom_component_chitchat": "ChitChatExtractor"
